...
const helpContent = {
    shellType: {
        ...
        body: 'Loại pháo hoa sẽ được phóng. Chọn "Ngẫu nhiên" để có một bộ sưu tập đẹp!'
    },
    shellSize: {
        header: 'Kích Thước Pháo Hoa',
        body: 'Kích thước của pháo hoa. Mô phỏng theo kích thước thực của vỏ pháo hoa, các vỏ pháo lớn có vụ nổ lớn với nhiều ngôi sao hơn, và đôi khi làm cho hiệu ứng phức tạp hơn. Tuy nhiên, các vỏ pháo lớn cũng đòi hỏi nhiều công suất xử lý hơn và có thể gây lag.'
    },
    quality: {
        header: 'Chất Lượng',
        body: 'Chất lượng đồ họa tổng thể. Nếu hiệu ứng không chạy mượt mà, hãy thử giảm chất lượng. Chất lượng cao tăng đáng kể số lượng tia lửa được vẽ và có thể gây lag.'
    },
    skyLighting: {
    ...
    scaleFactor: {
        header: 'Tỉ Lệ',
        body: 'Cho phép thay đổi tỉ lệ của tất cả pháo hoa, bản chất là di chuyển bạn gần hơn hoặc xa hơn. Đối với kích thước vỏ pháo lớn, việc giảm tỉ lệ một chút có thể thuận tiện, đặc biệt là trên điện thoại hoặc máy tính bảng.'
    },
    autoLaunch: {
        header: 'Tự Động Phóng',
        body: 'Tự động phóng chuỗi pháo hoa. Ngồi lại và thưởng thức show, hoặc tắt để có đầy đủ kiểm soát.'
    },
    finaleMode: {
        header: 'Chế Độ Kết Thúc',
        body: 'Phóng những vụ nổ pháo hoa mạnh mẽ. Có thể gây lag. Yêu cầu "Tự Động Phóng" được kích hoạt.'
    },
    hideControls: {
        header: 'Ẩn Dieu Khiển',
        body: 'Ẩn đi các điều khiển trong suốt ở đầu trang màn hình. Hữu ích cho việc chụp ảnh màn hình hoặc trải nghiệm mượt mà hơn. Khi ẩn, bạn vẫn có thể nhấn vào góc phải trên cùng để mở lại menu này.'
    },
    fullscreen: {
    ...
    longExposure: {
        header: 'Mở Ông Kính',
        body: 'Hiệu ứng thử nghiệm giữ lại những đường sáng dài, tương tự như việc để mở ông kính máy ảnh.'
    }
};
